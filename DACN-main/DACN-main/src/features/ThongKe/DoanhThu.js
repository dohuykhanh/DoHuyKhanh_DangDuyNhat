  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='row'>
        ...
        <div className='col'></div>
        <div className='col' style={{position:"relative" , top:"30px",color:"red"}}><h5><b><i>Tổng Doanh Thu:{formatter.format(money)} VND</i></b></h5></div>
        <div className='col' style={{position:"relative" , top:"30px",color:"red"}}><h5><b><i>Loi Nhuan:{formatter.format(money- Tientru - Tientru1)} VND</i></b></h5></div>
      </div>
    </div>
